          ...
          <div ref={valuesRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {communityValues.map((value, index) => (
              <div key={value.id} className="value-card">
                <div className="bg-white rounded-xl shadow-lg border border-earth-100 p-6 md:p-8 h-full hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <h4 className="text-lg md:text-xl font-serif text-forest-900 mb-4">{value.title}</h4>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8 md:pt-16">
              {timelinePhases.map((phase, index) => (
                <div key={phase.id} className="timeline-item relative">
                  ...
                  <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 w-10 h-10 rounded-full bg-white border-4 border-earth-400 flex items-center justify-center hidden md:flex">
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6 border border-earth-100 h-full hover:shadow-lg transition-all duration-300">
                    ...
                    <div className="flex items-center mb-3 md:hidden">
                      <div className="w-8 h-8 mr-3 rounded-full bg-white border-2 border-earth-400 flex items-center justify-center flex-shrink-0">
                        <div className="text-earth-700 scale-75">
                          {phase.icon}
                        </div>
                      </div>
                      <div className="text-earth-500 text-sm font-medium">{phase.date}</div>
                    </div>
